...
public class Q7CreateCustomerProjectTaskAndDeleteAll 
{
	...
	private static void createProject(String pro)
	{
		try {
			...
			Thread.sleep(3000);
			WebElement oEle=oBrowser.findElement(By.xpath("//div[text()='LoginPageBuild ']"));
			Assert.assertTrue(oEle.isDisplayed());
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static void createTask(String task)
	{
		try {
			...
			Thread.sleep(1000);
			/*
			 * oBrowser.findElement(By.id("ext-gen170")).click(); Thread.sleep(1000);
			 */
			...
			Thread.sleep(3000);
			WebElement oEle=oBrowser.findElement(By.xpath("//div[text()='Functional Testing']"));
			Assert.assertTrue(oEle.isDisplayed());
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	{
		try {
			oBrowser.findElement(By.xpath("//div[text()='LoginPageBuild ']")).click();
			Thread.sleep(1000);
