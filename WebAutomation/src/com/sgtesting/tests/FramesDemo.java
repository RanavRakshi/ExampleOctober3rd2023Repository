...
public class FramesDemo {
	...
	private static void navigate()
	{
		try
		{
			oBrowser.navigate().to("file:///G:/Git_Repository/Current_Workspace/ExampleOctober3rd2023Repository/WebAutomation/webpages/FramesTest.html");
			Thread.sleep(4000);
		}catch (Exception e) 
		{
			e.printStackTrace();
	...
	private static void handleFrames()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.switchTo().frame("egister");
			Thread.sleep(1000);
